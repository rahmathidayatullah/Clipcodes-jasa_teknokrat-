...
public class Page_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("http://belajar-ilmu-servis-komputer-jaringan.blogspot.co.id/2013/03/materi-komputer-dan-belajar-servis.html");
    ...
    public void buttonteknisi() {
        ...
        buttonteknisi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),servicepclist.class);
